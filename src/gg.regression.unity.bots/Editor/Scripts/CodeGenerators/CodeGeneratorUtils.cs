...
namespace RegressionGames
{
    ...
    public static class CodeGeneratorUtils
    {
        public static readonly string HeaderComment = "/// <auto-generated>" + Environment.NewLine +
                                                      ...
                                                      "// ReSharper disable ClassNeverInstantiated.Global" + Environment.NewLine +
                                                      "// ReSharper disable RedundantAssignment" + Environment.NewLine +
                                                      "// ReSharper disable InconsistentNaming" + Environment.NewLine +
                                                      "// ReSharper disable CheckNamespace" + Environment.NewLine  + Environment.NewLine;
