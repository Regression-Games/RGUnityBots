...
[ActionManagerGPTBot](../GenericBots/Experimental/ActionManagerGPTBot.cs) - Example of how to use the action manager to generate and evaluate LLM prompts/responses