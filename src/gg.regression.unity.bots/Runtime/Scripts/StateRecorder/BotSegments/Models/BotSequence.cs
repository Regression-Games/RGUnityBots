...
namespace RegressionGames.StateRecorder.BotSegments.Models
{
    ...
    public class BotSequence
    {
        ...
        /**
         * <summary>
         * Adds the specified segment to this sequence. This assumes that the path is a Unity Resource path to a bot segment or segment list json file.
         * If the .json path specified is NOT parsable as a BotSegmentList, this API will parse it as a segment instead.
         * </summary>
         */
