...
namespace RegressionGames.StateRecorder.JsonConverters
{
    ...
    public class ColorJsonConverter : Newtonsoft.Json.JsonConverter, ITypedStringBuilderConverter<Color>
    {
        ...
        void ITypedStringBuilderConverter<Color>.WriteToStringBuilder(StringBuilder stringBuilder, Color val)
        {
            WriteToStringBuilder(stringBuilder, val);
        }

        string ITypedStringBuilderConverter<Color>.ToJsonString(Color val)
        {
