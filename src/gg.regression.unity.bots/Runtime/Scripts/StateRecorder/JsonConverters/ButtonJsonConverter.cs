...
{
    public class ButtonJsonConverter : Newtonsoft.Json.JsonConverter, ITypedStringBuilderConverter<Button>, IBehaviourStringBuilderWritable
    {
        ...
        void ITypedStringBuilderConverter<Button>.WriteToStringBuilder(StringBuilder stringBuilder, Button val)
        {
            WriteToStringBuilder(stringBuilder, val);
        }

        string ITypedStringBuilderConverter<Button>.ToJsonString(Button val)
        {
