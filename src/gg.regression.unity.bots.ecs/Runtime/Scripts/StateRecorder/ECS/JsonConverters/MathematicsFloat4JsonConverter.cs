...
{
    public class MathematicsFloat4JsonConverter : Newtonsoft.Json.JsonConverter
    {
        ...
        public static void WriteToStringBuilderNullable(StringBuilder stringBuilder, float4? f)
        {
            if (!f.HasValue)
            {
        ...
        public static void WriteToStringBuilder(StringBuilder stringBuilder, float4 value)
        {
        ...
        private static string ToJsonString(float4 val)
        {
        ...
        {
            return objectType == typeof(float4) || objectType == typeof(float4?);
        }
    }
}
