...
{
    public class MathematicsFloat2JsonConverter : Newtonsoft.Json.JsonConverter
    {
        ...
        public static void WriteToStringBuilderNullable(StringBuilder stringBuilder, float2? f)
        {
            if (!f.HasValue)
            {
        ...
        public static void WriteToStringBuilder(StringBuilder stringBuilder, float2 value)
        {
        ...
        private static string ToJsonString(float2 val)
        {
