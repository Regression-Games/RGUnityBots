...
{
    public class MathematicsUint3JsonConverter : Newtonsoft.Json.JsonConverter
    {
        ...
        public static void WriteToStringBuilderNullable(StringBuilder stringBuilder, uint3? f)
        {
            if (!f.HasValue)
            {
        ...
        public static void WriteToStringBuilder(StringBuilder stringBuilder, uint3 value)
        {
        ...
        private static string ToJsonString(uint3 val)
        {
        ...
        {
            return objectType == typeof(uint3) || objectType == typeof(uint3?);
        }
    }
}
