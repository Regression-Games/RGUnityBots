...
{
    public class MathematicsDouble2JsonConverter : Newtonsoft.Json.JsonConverter
    {
        ...
        public static void WriteToStringBuilderNullable(StringBuilder stringBuilder, double2? f)
        {
            if (!f.HasValue)
            {
        ...
        public static void WriteToStringBuilder(StringBuilder stringBuilder, double2 value)
        {
        ...
        private static string ToJsonString(double2 val)
        {
        ...
        {
            return objectType == typeof(double2) || objectType == typeof(double2?);
        }
    }
}
