...
{
    public class MathematicsDouble3JsonConverter : Newtonsoft.Json.JsonConverter
    {
        ...
        public static void WriteToStringBuilderNullable(StringBuilder stringBuilder, double3? f)
        {
            if (!f.HasValue)
            {
        ...
        public static void WriteToStringBuilder(StringBuilder stringBuilder, double3 value)
        {
        ...
        private static string ToJsonString(double3 val)
        {
        ...
        {
            return objectType == typeof(double3) || objectType == typeof(double3?);
        }
    }
}
