...
{
    public class MathematicsUint2JsonConverter : Newtonsoft.Json.JsonConverter
    {
        ...
        public static void WriteToStringBuilderNullable(StringBuilder stringBuilder, uint2? f)
        {
            if (!f.HasValue)
            {
        ...
        public static void WriteToStringBuilder(StringBuilder stringBuilder, uint2 value)
        {
        ...
        private static string ToJsonString(uint2 val)
        {
        ...
        {
            return objectType == typeof(uint2) || objectType == typeof(uint2?);
        }
    }
}
