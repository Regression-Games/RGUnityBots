...
[![Static Badge](https://img.shields.io/badge/Latest%20Version-0.0.28-rc2-blue)](https://docs.regression.gg)
...
```
https://github.com/Regression-Games/RGUnityBots.git?path=src/gg.regression.unity.bots#v0.0.28-rc2
```
